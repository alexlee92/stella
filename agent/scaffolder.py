...
def _do_process(payload: Dict[str, Any], company_id: int) -> Any:
    ...
    raise NotImplementedError("Implement _do_process for {name}")
...
def export_{name}_csv(
    ...
    # TODO: générer le CSV, uploader vers S3 ou stockage local, envoyer l'email
    return "export_path_placeholder.csv"
''',
    },
    "api-pagination": {
...
async def list_{name}s(
    ...
    """
    # TODO: Brancher la query SQLAlchemy
