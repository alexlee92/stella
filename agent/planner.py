...
- read_file_range: {{"path": "relative/path.py", "start_line": 1, "end_line": 80}}
...
- action must be one of:
  list_files, read_file, read_many, read_file_range, search_code,
  create_file, propose_edit, apply_edit, apply_all_staged,
  delete_file, move_file, run_tests, run_quality, project_map,
