...
from stella_ai import __version__, urls, utils
from stella_ai.dump import dump  # noqa: F401

stella_user_agent = f"Stella/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["stella-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({stella_user_agent})"}
        try:
            with httpx.Client(
