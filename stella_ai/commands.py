...
from stella_ai import models, prompts, voice
from stella_ai.editor import pipe_editor
from stella_ai.format_settings import format_settings
from stella_ai.help import Help, install_help_extra
from stella_ai.io import CommandCompletionException
from stella_ai.llm import litellm
from stella_ai.repo import ANY_GIT_ERROR
from stella_ai.run_cmd import run_cmd
from stella_ai.scrape import Scraper, install_playwright
from stella_ai.utils import is_image_file
...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by stella"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.stella_commit_hashes:
            self.io.tool_error("The last commit was not made by stella in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so stella can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to stellaignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use stella.")

    def cmd_help(self, args):
        "Ask questions about stella"
        ...
        from stella_ai.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of stella was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from stella_ai.report import report_github_issue
