---
title: o1 tops stella's new polyglot leaderboard
excerpt: o1 scores the top result on stella's new multi-language, more challenging coding benchmark.
...
# o1 tops stella's new polyglot leaderboard
{: .no_toc }
...
new 
[stella polyglot leaderboard](/docs/leaderboards/), significantly ahead of
other top LLMs.
The new polyglot benchmark uses many popular coding languages
and was designed to be 
*much more challenging* than stella's original
...
{: .note :}
See the main 
[stella leaderboard](https://stella.chat/docs/leaderboards/)
...
Like stella's original code editing benchmark,
...
Stella's original code editing benchmark was 
...
[stella polyglot benchmark repo](https://github.com/Stella-AI/polyglot-benchmark)
on GitHub.
