...
excerpt: Sonnet's score on the stella code editing benchmark has been stable since it launched.
...
[stella code editing benchmark](/docs/benchmarks.html#the-benchmark)
via the API.
...
to evaluate the effects of small changes to stella's system prompts.
...
> The 
> [stella LLM code editing leaderboard](https://stella.chat/docs/leaderboards/)
