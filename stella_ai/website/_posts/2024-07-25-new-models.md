...
[stella's code editing leaderboard](https://stella.chat/docs/leaderboards/)
...
You can code with all of these models using stella like this:
...
$ stella --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ stella --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ stella --model openrouter/meta-llama/llama-3.1-405b-instruct
$ stella --model openrouter/meta-llama/llama-3.1-70b-instruct
$ stella --model openrouter/meta-llama/llama-3.1-8b-instruct
```

See the
[installation instructions](https://stella.chat/docs/install.html)
and other
[documentation](https://stella.chat/docs/usage.html)
for more details.
...
secured #7 on stella's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on stella's code editing
benchmark. 
