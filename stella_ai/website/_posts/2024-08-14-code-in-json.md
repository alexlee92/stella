...
> Figure 1: Stella coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why stella uses a plain text format for LLMs to specify code edits (below),
...
Previous [stella benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[stella "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
stella's "whole" edit format, where the
...
#### Notes on the stella leaderboard

*The results presented here are not directly comparable to results
from the main
[stella LLM leaderboard](https://stella.chat/docs/leaderboards/).
