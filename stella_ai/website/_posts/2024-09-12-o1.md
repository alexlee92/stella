---
title: o1-preview is SOTA on the stella leaderboard
...
# OpenAI o1-preview is SOTA on the stella leaderboard
...
OpenAI o1-preview scored 79.7% on stella's code editing benchmark,
...
It is much more practical to use stella's
...
The o1-preview model had trouble conforming to stella's diff edit format.
The o1-mini model had trouble conforming to both the whole and diff edit formats.
Stella is extremely permissive and tries hard to accept anything close
...
It seems likely that stella could optimize its prompts and edit formats to
better harness the o1 models.


## Using stella with o1

OpenAI's new o1 models are supported in v0.57.0 of stella:
...
> based on stella v0.56.1-dev.
> See the [stella leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest stella releases.
