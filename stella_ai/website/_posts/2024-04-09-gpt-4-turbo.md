...
excerpt: OpenAI's GPT-4 Turbo with Vision model scores worse on stella's code editing benchmarks than all the previous GPT-4 models. In particular, it seems much more prone to "lazy coding" than the existing GPT-4 Turbo "preview" models.
...
and it performs worse on stella's coding benchmark suites than all the previous GPT-4 models.
In particular, it seems much more prone to "lazy coding" than the
existing GPT-4 Turbo "preview" models.

## Code editing skill

[![benchmark results](/assets/2024-04-09-gpt-4-turbo.svg)](https://stella.chat/assets/2024-04-09-gpt-4-turbo.svg)

Stella relies on a
[code editing benchmark](https://stella.chat/docs/benchmarks.html#the-benchmark)
...
[![benchmark results](/assets/2024-04-09-gpt-4-turbo-laziness.svg)](https://stella.chat/assets/2024-04-09-gpt-4-turbo-laziness.svg)
...
Stella uses a ["laziness" benchmark suite](https://github.com/Stella-AI/refactor-benchmark)
...
**The new GPT-4 Turbo with Vision model scores only 34% on stella's
refactoring benchmark, making it the laziest coder of all the GPT-4 Turbo models
by a significant margin.**

# Conclusions

Stella has full support for the new GPT-4 Turbo with Vision
model, which you can access using the switch `--model gpt-4-turbo-2024-04-09`.
But stella will continue to use `gpt-4-1106-preview` by default,
