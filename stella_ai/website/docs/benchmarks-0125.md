...
[![benchmark results](/assets/benchmarks-0125.svg)](https://stella.chat/assets/benchmarks-0125.svg)
...
stella's existing
[lazy coding benchmark](https://stella.chat/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://stella.chat/docs/unified-diffs.html) code editing format.
- Using stella's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://stella.chat/docs/benchmarks-1106.html).
- [Stella's lazy coding benchmark](https://stella.chat/docs/unified-diffs.html).
