...
Stella can connect to local Ollama models.
...
Start working with stella and Ollama on your codebase:
...
stella --model ollama_chat/<model>
```
...
which is very small for working with stella.
...
By default, stella sets Ollama's context window 
...
with an
[`.stella.model.settings.yml` file](https://stella.chat/docs/config/adv-model-settings.html#model-settings)
like this:
