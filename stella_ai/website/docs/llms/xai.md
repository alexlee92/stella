...
Start working with stella and xAI on your codebase:
...
# Grok 3
stella --model xai/grok-3-beta

# Grok 3 fast (faster, more expensive)
stella --model xai/grok-3-fast-beta

# Grok 3 Mini
stella --model xai/grok-3-mini-beta

# Grok 3 Mini fast (faster, more expensive)
stella --model xai/grok-3-mini-fast-beta

# List models available from xAI
stella --list-models xai/
```
...
```bash
stella --model xai/grok-3-mini-beta --reasoning-effort high
```
