...
Stella can connect to [models provided by OpenRouter](https://openrouter.ai/models?o=top-weekly):
...
Start working with stella and OpenRouter on your codebase:
...
stella --model openrouter/<provider>/<model>

# List models available from OpenRouter
stella --list-models openrouter/
```

In particular, many stella users access Sonnet via OpenRouter:
...
2. By configuring "provider routing" in a `.stella.model.settings.yml` file.
...
See [Advanced model settings](https://stella.chat/docs/config/adv-model-settings.html#model-settings)
