...
Start working with stella and OpenAI on your codebase:
...
stella --list-models openai/
```

You can use `stella --model <model-name>` to use any other OpenAI model.
For example, if you want to use a specific version of GPT-4 Turbo
you could do `stella --model gpt-4-0125-preview`.
...
Stella is configured to work properly with these models
