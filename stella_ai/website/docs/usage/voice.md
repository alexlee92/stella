...
parent: Usage
nav_order: 100
description: Speak with stella about your code!
---

# Voice-to-code with stella

Speak with stella about your code! Request new features, test cases or bug fixes using your voice and let stella do the work of editing the files in your local git repo. As with all of stella's capabilities, you can use voice-to-code with an existing repo or to start a new project.

Voice support fits quite naturally into stella's AI pair programming
chat interface. Now you can fluidly switch between voice and text chat
when you ask stella to edit your code.
...
the stella chat session.

See the [installation instructions](https://stella.chat/docs/install/optional.html#enable-voice-coding) for
...
> Commit ef9e3e7 stella: Add a factorial endpoint that uses math.factorial.  
