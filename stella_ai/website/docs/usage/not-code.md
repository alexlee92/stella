...
parent: Usage
nav_order: 901
description: Use stella to edit configuration files, documentation, and other text-based formats.
---


# Editing config & text files

Stella isn't just for code, it can be very helpful when editing
almost any text file.
You can use stella to make changes to your shell & ssh settings, 
Dockerfiles
...
<div class="chat-transcript" markdown="1">
$ stella Dockerfile docker-compose.yml
...
<div class="chat-transcript" markdown="1">
$ stella /etc/hosts  # May need sudo
