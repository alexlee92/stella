...
nav_order: 15
description: How to configure stella with a YAML config file.
---

# YAML config file

Most of stella's options can be set in an `.stella.conf.yml` file.
Stella will look for a this file in these locations:
...
can also
[download from GitHub](https://github.com/Stella-AI/stella/blob/main/stella/website/assets/sample.stella.conf.yml).

<!--[[[cog
from stella.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("stella/website/assets/sample.stella.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .stella.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .stella.model.metadata.json
...
#input-history-file: .stella.input.history

## Specify the chat history file (default: .stella.chat.history.md)
#chat-history-file: .stella.chat.history.md
