...
Stella lets you specify API keys in a few ways:

- On the command line
- As environment variables
- In a `.env` file
- In your `.stella.conf.yml` config file

---

## OpenAI and Anthropic

Stella has special support for providing
...
[YAML config file](/docs/config/stella_conf.html), like this:
...
[`.stella.conf.yml` file](/docs/config/stella_conf.html)
