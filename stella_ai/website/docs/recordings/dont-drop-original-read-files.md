...
description: Follow along as stella is modified to preserve read-only files specified at launch when using the /drop command. Stella does this implementation and adds test coverage.
---
...
- 0:20 Let's explain the needed change to stella.
...
- 2:19 Let's ask stella to add tests for this.
