...
description: See how a new command-line option is added to automatically accept edits proposed by the architect model, with implementation. Stella also updates the project's HISTORY file.
---
...
- 0:40 Stella figured out that it should be passed to the Coder class.
...
- 1:42 That worked too. Let's have stella update the HISTORY file to document the new feature.
