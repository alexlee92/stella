---
parent: Stella LLM Leaderboards
...
{: .note :}
This old
[stella code editing leaderboard](edit.html)
has been replaced by the
new, much more challenging
[polyglot leaderboard](/docs/leaderboards/).

[Stella's code editing benchmark](/docs/benchmarks.html#the-benchmark) asks the LLM to edit python source files to complete 133 small coding exercises
from Exercism. 
...
- **Percent using correct edit format** - Measures the percent of coding tasks where the LLM complied with the edit format specified in the system prompt. If the LLM makes edit mistakes, stella will give it feedback and ask for a fixed copy of the edit. The best models can reliably conform to the edit format, without making errors.


## Notes on the edit format

Stella uses different "edit formats" to collect code edits from different LLMs.
...
Stella is configured to use the best edit format for the popular OpenAI and Anthropic models
and the [other models recommended on the LLM page](/docs/llms.html).
For lesser known models stella will default to using the "whole" editing format
...
See the
[benchmark README](https://github.com/Stella-AI/stella/blob/main/benchmark/README.md)
for information on running stella's code editing benchmarks.
Submit results by opening a PR with edits to the
[benchmark results data files](https://github.com/Stella-AI/stella/blob/main/stella/website/_data/).
...
files = [
    'stella/website/docs/leaderboards/edit.md',
    'stella/website/_data/edit_leaderboard.yml',
]
