...
# Stella LLM Leaderboards

Stella excels with LLMs skilled at writing and *editing* code,
and uses benchmarks to
evaluate an LLM's ability to follow instructions and edit code successfully without
human intervention.
[Stella's polyglot benchmark](https://stella.chat/2024/12/21/polyglot.html#the-polyglot-benchmark) tests LLMs on 225 challenging Exercism coding exercises across C++, Go, Java, JavaScript, Python, and Rust.

<h2 id="leaderboard-title">Stella polyglot coding leaderboard</h2>
...
files = [
    'stella/website/docs/leaderboards/index.md',
    'stella/website/_data/polyglot_leaderboard.yml',
]
