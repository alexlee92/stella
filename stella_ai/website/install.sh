...
install() {
    ...
    say ""
    say "Installing stella..."
    say ""
    # Install stella-chat using the newly installed uv
    ensure "${_install_dir}/uv" tool install --force --python python3.12 --with pip stella-chat@latest
