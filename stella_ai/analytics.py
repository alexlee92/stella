...
from stella_ai.models import model_info_manager
...
class Analytics:
    ...
    def enable(self):
        ...
        # Avoid noisy stderr output when network is blocked/offline.
    ...
    def get_data_file_path(self):
        try:
            data_file = Path.home() / ".stella" / "analytics.json"
    ...
    def posthog_error(self, *args, **kwargs):
        """Disable PostHog if callback reports a network/error condition."""
        # https://github.com/PostHog/posthog-python/blob/9e1bb8c58afaa229da24c4fb576c08bb88a75752/posthog/consumer.py#L86
        # https://github.com/Stella-AI/stella/issues/2532
        self.ph = None
